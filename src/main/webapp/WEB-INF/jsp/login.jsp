...
<head>
    ...
    <!-- img -->
    <link rel="stylesheet" href="${pageContext.request.contextPath}/img/1.jpg">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/img/2.jpg">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/img/3.jpg">
